package lk.sonali_bookshop.asset.good_received_note.controller;
...
//if there is on value in ledger need to update it
            if ( ledgerDB != null ) {
                ...
                if ( ledgerDB.getSellPrice().equals(ledger.getSellPrice()) ) {
                    ...
                    ledgerDB.setQuantity(Integer.toString(quantity)); ledgerDB.setGoodReceivedNote(goodReceivedNoteDb);
