package lk.sonali_bookshop.asset.invoice.service;
...
import lk.sonali_bookshop.asset.invoice.dao.InvoiceDao;
...
public class InvoiceService implements AbstractService< Invoice, Integer > {
  ...
  public ByteArrayInputStream createPDF(Integer id) throws DocumentException {
    ...
    Paragraph paragraph = new Paragraph("Sonali Bookshop \n  \t Minuwangoda \n", mainFont);
