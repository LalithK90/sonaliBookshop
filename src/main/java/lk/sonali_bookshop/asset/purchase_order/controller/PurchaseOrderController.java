package lk.sonali_bookshop.asset.purchase_order.controller;


import lk.sonali_bookshop.asset.common_asset.service.CommonService;
...
import lk.sonali_bookshop.asset.purchase_order.entity.enums.PurchaseOrderPriority;
import lk.sonali_bookshop.asset.purchase_order.entity.enums.PurchaseOrderStatus;
import lk.sonali_bookshop.asset.purchase_order.service.PurchaseOrderService;
import lk.sonali_bookshop.asset.purchase_order_item.entity.PurchaseOrderItem;
import lk.sonali_bookshop.asset.purchase_order_item.service.PurchaseOrderItemService;
import lk.sonali_bookshop.asset.supplier.entity.Supplier;
import lk.sonali_bookshop.asset.supplier.service.SupplierService;
import lk.sonali_bookshop.asset.supplier_item.controller.SupplierItemController;
import lk.sonali_bookshop.util.service.EmailService;
...
public class PurchaseOrderController {
  ...
  public PurchaseOrderController(PurchaseOrderService purchaseOrderService,
      ...
      , CommonService commonService, ItemService itemService,
  ...
  public String purchaseOrderPersist(@Valid @ModelAttribute PurchaseOrder purchaseOrder,
    ...
    List< PurchaseOrderItem > purchaseOrderItemList = null;
    ...
    if ( purchaseOrderSaved.getSupplier().getEmail() != null ) {
      ...
      for ( int i = 0; i < purchaseOrder.getPurchaseOrderItems().size(); i++ ) {
        ...
        PurchaseOrderItem purchaseOrderItem =
            purchaseOrderItemService.findById(purchaseOrderSaved.getPurchaseOrderItems().get(i).getId());
        message
            .append(item.getName())
            .append("\t\t\t\t\t")
